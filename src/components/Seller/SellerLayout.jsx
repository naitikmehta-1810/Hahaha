...
const SellerLayout = ({ title, description, children }) => {
      ...
      <section className="overflow-hidden py-20 bg-gray-2">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex flex-col xl:flex-row gap-7.5">
            ...
            return (<Link key={item.href} href={item.href} className={`rounded-md px-4.5 py-3 font-medium ease-out duration-200 ${isActive
                    ? "bg-blue text-white"
