    ...
    return (<>
      ...
      {cartItems.length > 0 ? (<section className="overflow-hidden py-20 bg-gray-2">
          ...
          <div className="text-center mt-8">
            ...
            <Link href="/shop-with-sidebar" className="w-96 mx-auto flex justify-center font-medium text-white bg-dark py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-opacity-95">
              Continue Shopping
            </Link>
          </div>
        </>)}
