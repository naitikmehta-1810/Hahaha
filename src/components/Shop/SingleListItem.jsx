...
const SingleListItem = ({ item }) => {
    ...
    return (<div className="group rounded-lg bg-white shadow-1">
      <div className="flex">
        ...
        }} aria-label="button for quick view" className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-blue">
