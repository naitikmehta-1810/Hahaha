...
const Testimonials = () => {
    ...
    return (<section className="overflow-hidden pb-16.5">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        <div className="">
          <div className="swiper testimonial-carousel common-carousel p-5">
            ...
            <Swiper ref={sliderRef} slidesPerView={3} spaceBetween={20} breakpoints={{
            ...
            1200: {
              ...
              {testimonialsData.map((item, key) => (<SwiperSlide key={key}>
