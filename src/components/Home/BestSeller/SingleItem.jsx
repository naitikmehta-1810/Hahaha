...
const SingleItem = ({ item }) => {
    ...
    const handleQuickViewUpdate = () => {
        dispatch(updateQuickView(Object.assign({}, item)));
    };
    // add to cart
    const handleAddToCart = () => {
        dispatch(addItemToCart(Object.assign(Object.assign({}, item), { quantity: 1 })));
    };
      ...
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        ...
        <div className="absolute right-0 bottom-0 translate-x-full w-full flex flex-col gap-2 p-5.5 ease-linear duration-300 group-hover:translate-x-0">
          <button onClick={() => {
            ...
            openModal();
        }} aria-label="button for quick view" id="bestOne" className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-white hover:bg-blue">
          ...
          <button onClick={() => handleAddToCart()} aria-label="button for add to cart" id="addCartOne" className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-white hover:bg-blue">
            <svg className="fill-current" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        }} aria-label="button for add to fav" id="addFavOne" className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-white hover:bg-blue">
            <svg className="fill-current" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
